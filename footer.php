...
<a title="<?php echo $lang['translit_link_text']; ?>" href="transliteration.php?ln=<?php echo $ln;?>"><?php echo $lang['translit_link_text']; ?></a>
 ...
 <span id="footer_cp"><?php echo $lang['copyright'] ?></span>&nbsp;&nbsp;<a title="<?php echo $lang['select_language'] ?>" href="#" onclick="javascript:DialogBox('<strong><?php echo $lang['select_language'] ?></strong>','<?php echo addslashes($lang['select_lang_list']); ?>');return false;"><?php echo $lang['language'] ?>
	</a><br>
 <br>
 <div id="ie7div">
